...
module.exports = async function (taskArgs, hre) {
    ...
    let tx = await (await omniCounter.incrementCounterWithAdapterParamsV1(
        dstChainId,
        dstAddr,
        taskArgs.gasAmount,
    ...
    console.log(`✅ Message Sent [${hre.network.name}] omniCounterIncrementWithParamsV1 on destination OmniCounter @ [${dstChainId}] [${dstAddr}]`)
