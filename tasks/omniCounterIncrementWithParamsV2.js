...
module.exports = async function (taskArgs, hre) {
    ...
    let tx = await (await omniCounter.incrementCounterWithAdapterParamsV2(
        dstChainId,
        dstAddr,
        taskArgs.gasAmount,
    ...
    console.log(`✅ Message Sent [${hre.network.name}] omniCounterIncrementWithParamsV2 on destination OmniCounter @ [${dstChainId}] [${dstAddr}]`)
