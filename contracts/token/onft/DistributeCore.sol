...
//
//    struct MultiMinDstGas {
//        uint baseGas;
//        uint n;
//    }
//
//    event SetUseCustomAdapterParams(bool _useCustomAdapterParams);
//    event SetMultiMinDstGasLookup(uint16 _dstChainId, uint baseGas, uint n);
...
//
//    mapping(uint16 => MultiMinDstGas) public multiMinDstGasLookup;
...
//    }
//
//    function setMultiMinDstGasLookup(uint16 _dstChainId, uint _baseGas, uint _n) external onlyOwner {
//        require(_baseGas > 0, "LzApp: invalid _baseGas");
//        require(_n > 0, "LzApp: invalid _n");
//        multiMinDstGasLookup[_dstChainId] = MultiMinDstGas(_baseGas, _n);
//        emit SetMultiMinDstGasLookup(_dstChainId, _baseGas, _n);
//    }
//
...
//    }
//
//    function _checkMultiGasLimit(uint16 _dstChainId, uint _amount, bytes memory _adapterParams) internal view {
//        MultiMinDstGas memory multiMinDstGas = multiMinDstGasLookup[_dstChainId];
//        require(multiMinDstGas.baseGas > 0, "LzApp: multiMinDstGas baseGas not set");
//        require(multiMinDstGas.n > 0, "LzApp: multiMinDstGas n not set");
//        uint minGasLimit = multiMinDstGas.baseGas + (_amount * multiMinDstGas.n);
//        uint providedGasLimit = getGasLimit(_adapterParams);
//        require(providedGasLimit >= minGasLimit, "LzApp: multiMinDstGas limit is too low.");
//    }
//
...
//            _checkMultiGasLimit(_dstChainId, _tokenIdArray.length, _adapterParams);
//        }
//
