...
import "../../lzApp/NonblockingLzAppUpgradeableV2.sol";
import "./IONFT721CoreUpgradeable.sol";

abstract contract ONFT721CoreUpgradeableV2 is NonblockingLzAppUpgradeableV2, ERC165Upgradeable, IONFT721CoreUpgradeable {

    function initializeONFT721CoreUpgradeable(address _endpoint) public initializer {
        NonblockingLzAppUpgradeableV2.initializeNonblockingLzApp(_endpoint);
    }
