 ...
 */
abstract contract LzAppUpgradeableV2 is OwnableUpgradeable, ILayerZeroReceiverUpgradeable, ILayerZeroUserApplicationConfigUpgradeable {
    ILayerZeroEndpointUpgradeable public lzEndpoint;

    mapping(uint16 => bytes) public trustedRemoteLookup;

    string public constant testOne = "abc";
    string public constant testTwo = "123";
