...
describe("ONFT721Upgradeable: ", function () {
    ...
    beforeEach(async function () {
        ...
        ONFT_A = await upgrades.deployProxy(ONFT, [name, symbol, lzEndpointMockA.address])
        ONFT_B = await upgrades.deployProxy(ONFT, [name, symbol, lzEndpointMockB.address])
    ...
    it("sendFrom() - your own tokens", async function () {
        ...
        // estimate nativeFees
        nativeFee = (await ONFT_B.estimateSendFee(chainId_A, owner.address, tokenId, false, "0x")).nativeFee
