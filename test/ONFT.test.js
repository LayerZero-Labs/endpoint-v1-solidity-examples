...
describe.only("ONFT: ", function () {
    ...
    it("mint on the source chain and send ONFT to the destination chain", async function () {
        ...
        console.log("here");
        await this.OmnichainNonFungibleTokenSrc.ownerOf(44)
        // await expect(this.OmnichainNonFungibleTokenSrc.ownerOf(onftTokenId)).to.be.revertedWith("ERC721: owner query for nonexistent oft")
